    ...
    <div className="container">
        <div className="flex flex-wrap">
            ...
            <div className='w-full px-4 lg:w-1/2'>
                <h3 className='font-bold text-primary mb-4 text-2xl lg:mt-10'>References</h3>
                <p className='font-medium text-slate-400 lg:text-lg lg:mb-5'>For reference, you can find my contact details and links to my professional profiles below. These references include:</p>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className='flex items-center mb-4 lg:mb-0'>
                        <Link href="mailto:safari.erie@gmail.com" className='w-9 h-9 mr-3 rounded-full border border-white hover:bg-primary hover:text-white flex items-center justify-center'>
                        ...
                        <span className='font-medium text-white'>safari.erie@gmail.com</span>
                    </div>

                    <div className='flex items-center mb-4 lg:mb-0'>
                        <Link href="https://github.com/safari05" target='_blank' className='w-9 h-9 mr-3 rounded-full border border-white hover:bg-primary hover:text-white flex items-center justify-center'>
                        ...
                        <span className='font-medium text-white'>github:safari05</span>
                    </div>

                    <div className='flex items-center'>
                        <Link href="https://gitlab.com/safari.erie" target='_blank' className='w-9 h-9 mr-3 rounded-full border border-white hover:bg-primary hover:text-white flex items-center justify-center'>
                        ...
                        <span className='font-medium text-white'>gitlab:safari.erie</span>
                    </div>
                </div>
            </div>
        </div>
